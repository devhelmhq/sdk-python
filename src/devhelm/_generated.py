...
#   timestamp: 2026-04-19T10:56:52+00:00
...
class ServiceComponentDto(BaseModel):
    ...
    is_group: Annotated[bool | None, Field(alias="isGroup")] = None
...
class ServicePollResultDto(BaseModel):
    ...
    passed: Annotated[
        bool | None, Field(description="Whether the poll succeeded", examples=[True])
    ] = None
...
class StatusPageComponentDto(BaseModel):
    ...
    show_uptime: Annotated[bool | None, Field(alias="showUptime")] = None
    display_order: Annotated[int | None, Field(alias="displayOrder")] = None
    page_order: Annotated[int | None, Field(alias="pageOrder")] = None
    exclude_from_overall: Annotated[bool | None, Field(alias="excludeFromOverall")] = (
        None
    )
    start_date: Annotated[AwareDatetime | None, Field(alias="startDate")] = None
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
...
class StatusPageDto(BaseModel):
    ...
    workspace_id: Annotated[int | None, Field(alias="workspaceId")] = None
    name: Annotated[str, Field(min_length=1)]
    slug: Annotated[str, Field(min_length=1)]
    description: str | None = None
...
class StatusPageIncidentDto(BaseModel):
    ...
    auto_resolve: Annotated[bool | None, Field(alias="autoResolve")] = None
...
class CreateNotificationPolicyRequest(BaseModel):
    ...
    escalation: EscalationChain
    enabled: Annotated[
        bool, Field(description="Whether this policy is enabled (default true)")
    ]
    priority: Annotated[
        int,
        Field(
