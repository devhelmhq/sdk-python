...
class KeyLocation(BaseModel):
    model_config = ConfigDict(extra="ignore", populate_by_name=True)
    key: Annotated[str, Field(description="Secret name the code reads", max_length=255)]
...
class CursorPageNotificationDispatchDto(BaseModel):
    ...
    total: Annotated[
        int | None,
        Field(
            description="Unfiltered count of retained rows for this collection; null when the endpoint does not compute a total"
        ),
    ] = None
