...
class AlertChannelDisplayConfig(BaseModel):
    ...
    phone_numbers: Annotated[
        ...
        Field(
            alias="phoneNumbers",
            description="Recipient phone numbers in E.164 format (SMS / phone-call channels)",
        ),
    ] = None
...
class PhoneCallChannelConfig(BaseModel):
    ...
    phone_numbers: Annotated[
        ...
        Field(
            alias="phoneNumbers",
            description="Recipient phone numbers in E.164 format, e.g. +14155550123",
            min_length=1,
        ),
    ]
    voice_language: Annotated[
...
class UpdatePhoneCallChannelConfig(BaseModel):
    ...
    voice_language: Annotated[
        ...
        Field(
            alias="voiceLanguage",
            description="TTS voice language/locale (default: en-US)",
        ),
    ] = None
    preferred_language: Annotated[
        str | None,
        Field(
            alias="preferredLanguage",
            description="Preferred language for TTS and notifications (BCP-47, e.g. en-US, de-DE)",
        ),
    ] = None
