...
class EmailDnsRecordDto(BaseModel):
    ...
    last_checked_at: Annotated[
        AwareDatetime | None,
        Field(alias="lastCheckedAt", description="When this record was last checked"),
    ] = None
...
class EmailDomainDto(BaseModel):
    ...
    dns_records: Annotated[
        ...
        Field(alias="dnsRecords", description="DNS records to publish for this domain"),
    ]
    created_at: Annotated[
        AwareDatetime,
...
class WebhookEventDto(BaseModel):
    ...
    body: Annotated[
        str | None, Field(description="Request body as text, at most 256 KB")
    ] = None
...
class EmailMessageDto(BaseModel):
    ...
    text: Annotated[
        str | None, Field(description="Plain-text body, at most 256 KB")
    ] = None
    html: Annotated[str | None, Field(description="HTML body, at most 256 KB")] = None
    body_truncated: Annotated[
        bool | None,
        Field(
            alias="bodyTruncated",
