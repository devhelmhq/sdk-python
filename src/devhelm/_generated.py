...
class AddIncidentUpdateRequest(BaseModel):
    body: Annotated[str, Field(description="Update message or post-mortem notes")]
...
class ApiKeyCreateResponse(BaseModel):
    ...
    name: Annotated[str, Field(description="Human-readable name for this API key")]
    key: Annotated[
        str, Field(description="Full API key value in dh_live_* format; store this now")
    ]
    created_at: Annotated[
        AwareDatetime,
...
class ApiKeyDto(BaseModel):
    id: Annotated[int, Field(description="Unique API key identifier")]
    name: Annotated[str, Field(description="Human-readable name for this API key")]
    key: Annotated[str, Field(description="Full API key value in dh_live_* format")]
    created_at: Annotated[
        AwareDatetime,
        Field(alias="createdAt", description="Timestamp when the key was created"),
    ]
...
class AssertionResultDto(BaseModel):
    ...
    expected: Annotated[str, Field(description="Expected value", examples=["200"])]
    actual: Annotated[str, Field(description="Actual value observed", examples=["503"])]
...
class AssertionTestResultDto(BaseModel):
    ...
    expected: Annotated[str, Field(description="Expected value")]
    actual: Annotated[str, Field(description="Actual value observed during the test")]
...
class AuditEventDto(BaseModel):
    ...
    resource_id: Annotated[
        str, Field(alias="resourceId", description="ID of the affected resource")
    ]
...
class ComponentPosition(BaseModel):
    ...
    display_order: Annotated[
        int | None,
        Field(alias="displayOrder", description="New display order (0-based)"),
    ] = None
    group_id: Annotated[
        UUID | None,
...
class CreateStatusPageComponentRequest(BaseModel):
    ...
    type: Annotated[
        Type2, Field(description="Component type: MONITOR, GROUP, or STATIC")
    ]
    monitor_id: Annotated[
        UUID | None,
...
class CursorPage(BaseModel):
    data: Annotated[list[dict[str, Any]], Field(description="Items on this page")]
...
class EnvironmentDto(BaseModel):
    ...
    slug: Annotated[str, Field(description="URL-safe identifier")]
    variables: Annotated[
        dict[str, str],
...
class GroupComponentOrder(BaseModel):
    group_id: Annotated[
        UUID | None,
        Field(alias="groupId", description="Group these components belong to"),
    ] = None
    positions: Annotated[
...
class IncidentDto(BaseModel):
    ...
    status: Annotated[
        Status5, Field(description="Current lifecycle status (OPEN, RESOLVED, etc.)")
    ]
    severity: Annotated[
    ...
    shortlink: Annotated[
        str, Field(description="Short URL linking to the incident details")
    ]
...
class IncidentFilterParams(BaseModel):
    ...
    resource_group_id: Annotated[UUID, Field(alias="resourceGroupId")]
    tag_id: Annotated[UUID, Field(alias="tagId")]
    environment_id: Annotated[UUID, Field(alias="environmentId")]
    started_from: Annotated[AwareDatetime, Field(alias="startedFrom")]
    started_to: Annotated[AwareDatetime, Field(alias="startedTo")]
    page: Annotated[int, Field(ge=0)]
    size: Annotated[int, Field(ge=1, le=200)]
...
class IncidentUpdateDto(BaseModel):
    ...
    old_status: Annotated[OldStatus, Field(alias="oldStatus")]
...
class MaintenanceUpdateDto(BaseModel):
    ...
    body: Annotated[str, Field(description="Update message from the vendor")]
...
class MaintenanceWindowDto(BaseModel):
    ...
    reason: Annotated[
        str, Field(description="Human-readable reason for the maintenance")
    ]
    suppress_alerts: Annotated[
        bool,
        Field(
...
class MemberDto(BaseModel):
    ...
    name: Annotated[str, Field(description="Member display name; null if not set")]
    org_role: Annotated[
        OrgRole,
        Field(
            alias="orgRole",
    ...
    status: Annotated[
        Status8, Field(description="Membership status (ACTIVE, PENDING, SUSPENDED)")
    ]
    created_at: Annotated[
        AwareDatetime,
        Field(
...
class MonitorTestResultDto(BaseModel):
    ...
    response_time_ms: Annotated[int, Field(alias="responseTimeMs")]
    response_headers: Annotated[dict[str, list[str]], Field(alias="responseHeaders")]
    body_preview: Annotated[str, Field(alias="bodyPreview")]
    response_size_bytes: Annotated[int, Field(alias="responseSizeBytes")]
    redirect_count: Annotated[int, Field(alias="redirectCount")]
...
class NotificationDispatchDto(BaseModel):
    ...
    status: Annotated[Status9, Field(description="Current dispatch state")]
...
class OrganizationDto(BaseModel):
    ...
    size: Annotated[str, Field(description="Team size range (e.g. 1-10, 11-50)")]
    industry: Annotated[
        str, Field(description="Industry vertical (e.g. SaaS, Fintech)")
    ]
    website_url: Annotated[
        str, Field(alias="websiteUrl", description="Organization website URL")
    ]
...
class PublishStatusPageIncidentRequest(BaseModel):
    ...
    impact: Annotated[Impact, Field(description="Impact level; null keeps draft value")]
    status: Annotated[
        Status10,
        Field(
    ...
    body: Annotated[
        str, Field(description="Initial update body; null keeps draft value")
    ]
    affected_components: Annotated[
...
class ResolveIncidentRequest(BaseModel):
    body: Annotated[
        str, Field(description="Optional resolution message or post-mortem notes")
    ]
...
class ResourceGroupHealthDto(BaseModel):
    status: Annotated[
        Status11, Field(description="Worst-of health status across all members")
    ]
...
class ResourceGroupMemberDto(BaseModel):
    ...
    name: Annotated[
        str, Field(description="Display name of the referenced monitor or service")
    ]
    slug: Annotated[
        str,
        Field(
    ...
    status: Annotated[
        Status11, Field(description="Computed health status for this member")
    ]
...
class ScheduledMaintenanceDto(BaseModel):
    ...
    impact: Annotated[str, Field(description="Reported impact level")]
    shortlink: Annotated[
        str, Field(description="Vendor-provided short URL to the maintenance page")
    ]
    scheduled_for: Annotated[
        AwareDatetime,
        Field(
...
class SeoMetadataDto(BaseModel):
    ...
    description: Annotated[
        str, Field(description="Full description for the service page")
    ]
    about: Annotated[
        str,
...
class ServiceCatalogDto(BaseModel):
    ...
    name: str
    category: str
    official_status_url: Annotated[str, Field(alias="officialStatusUrl")]
    developer_context: Annotated[str, Field(alias="developerContext")]
...
class ServiceComponentDto(BaseModel):
    ...
    vendor_created_at: Annotated[AwareDatetime, Field(alias="vendorCreatedAt")]
    ...
    group_name: Annotated[
        str, Field(alias="groupName", description="Display name of the parent group")
    ]
    uptime: ComponentUptimeSummaryDto
    status_changed_at: Annotated[AwareDatetime, Field(alias="statusChangedAt")]
...
class ServiceIncidentDto(BaseModel):
    id: UUID
    service_id: Annotated[UUID, Field(alias="serviceId")]
    service_slug: Annotated[str, Field(alias="serviceSlug")]
    ...
    resolved_at: Annotated[AwareDatetime, Field(alias="resolvedAt")]
    updated_at: Annotated[AwareDatetime, Field(alias="updatedAt")]
    shortlink: str
    detected_at: Annotated[AwareDatetime, Field(alias="detectedAt")]
    vendor_created_at: Annotated[AwareDatetime, Field(alias="vendorCreatedAt")]
...
class ServiceIncidentUpdateDto(BaseModel):
    status: str
    body: str
    display_at: Annotated[AwareDatetime, Field(alias="displayAt")]
...
class ServiceStatusDto(BaseModel):
    overall_status: Annotated[str, Field(alias="overallStatus")]
    last_polled_at: Annotated[AwareDatetime, Field(alias="lastPolledAt")]
...
class ServiceSubscriptionDto(BaseModel):
    ...
    enabled: bool
    logo_url: Annotated[
        str, Field(alias="logoUrl", description="Logo URL from the service catalog")
    ]
    overall_status: Annotated[
        str,
        Field(
...
class StatusPageComponentGroupDto(BaseModel):
    ...
    page_order: Annotated[int, Field(alias="pageOrder")]
    collapsed: bool
    components: list[StatusPageComponentDto]
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
    updated_at: Annotated[AwareDatetime, Field(alias="updatedAt")]
...
class StatusPageCustomDomainDto(BaseModel):
    ...
    verified_at: Annotated[AwareDatetime, Field(alias="verifiedAt")]
    verification_error: Annotated[str, Field(alias="verificationError")]
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
    updated_at: Annotated[AwareDatetime, Field(alias="updatedAt")]
    primary: bool
...
class StatusPageDto(BaseModel):
    ...
    component_count: Annotated[int, Field(alias="componentCount")]
    subscriber_count: Annotated[int, Field(alias="subscriberCount")]
    overall_status: Annotated[OverallStatus, Field(alias="overallStatus")]
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
    updated_at: Annotated[AwareDatetime, Field(alias="updatedAt")]
...
class StatusPageIncidentUpdateDto(BaseModel):
    ...
    status: Status14
    body: str
    created_by: Annotated[CreatedBy1, Field(alias="createdBy")]
    created_by_user_id: Annotated[int, Field(alias="createdByUserId")]
    notify_subscribers: Annotated[bool, Field(alias="notifySubscribers")]
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
...
class TagDto(BaseModel):
    ...
    name: Annotated[str, Field(description="Tag name, unique within the org")]
    color: Annotated[
        str, Field(description="Hex color code for display (e.g. #6B7280)")
    ]
    created_at: Annotated[
        AwareDatetime,
...
class TlsInfoDto(BaseModel):
    ...
    subject_san: Annotated[
        list[str], Field(alias="subjectSan", description="Subject Alternative Names")
    ]
    issuer_cn: Annotated[
        str, Field(alias="issuerCn", description="Issuer common name", examples=["R3"])
    ]
    ...
    serial_number: Annotated[
        str, Field(alias="serialNumber", description="Certificate serial number")
    ]
    ...
    cipher_suite: Annotated[
        str, Field(alias="cipherSuite", description="Negotiated cipher suite")
    ]
...
class UpdateStatusPageIncidentRequest(BaseModel):
    ...
    status: Annotated[Status14, Field(description="New status; null preserves current")]
    impact: Annotated[
        Impact, Field(description="New impact level; null preserves current")
    ]
    affected_components: Annotated[
        list[AffectedComponent],
        Field(
...
class UpdateStatusPageRequest(BaseModel):
    ...
    visibility: Annotated[
        Visibility, Field(description="Page visibility; null preserves current")
    ]
    enabled: Annotated[
        bool, Field(description="Whether the page is enabled; null preserves current")
    ]
...
class UpdateTagRequest(BaseModel):
    name: Annotated[
        str, Field(description="New tag name", max_length=100, min_length=0)
    ]
    color: Annotated[
        str,
        Field(
...
class UpdateWebhookEndpointRequest(BaseModel):
    ...
    enabled: Annotated[
        bool, Field(description="Enable or disable delivery; null preserves current")
    ]
...
class WebhookDeliveryDto(BaseModel):
    ...
    response_status: Annotated[int, Field(alias="responseStatus")]
    response_latency_ms: Annotated[int, Field(alias="responseLatencyMs")]
    error_message: Annotated[str, Field(alias="errorMessage")]
    delivered_at: Annotated[AwareDatetime, Field(alias="deliveredAt")]
    failed_at: Annotated[AwareDatetime, Field(alias="failedAt")]
    next_retry_at: Annotated[AwareDatetime, Field(alias="nextRetryAt")]
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
...
class WebhookEndpointDto(BaseModel):
    ...
    description: Annotated[
        str, Field(description="Human-readable description of this endpoint")
    ]
    subscribed_events: Annotated[
        list[str],
        Field(
...
class WebhookSigningSecretDto(BaseModel):
    configured: bool
    masked_secret: Annotated[str, Field(alias="maskedSecret")]
...
class CheckResultDetailsDto(BaseModel):
    ...
    redirect_target: Annotated[
        str, Field(alias="redirectTarget", description="Final URL after redirects")
    ]
...
class ComponentUptimeDayDto(BaseModel):
    ...
    incidents: Annotated[
        list[IncidentRef], Field(description="Incidents that overlapped this day")
    ]
...
class IncidentDetailDto(BaseModel):
    ...
    status_page_incidents: Annotated[
        list[LinkedStatusPageIncidentDto], Field(alias="statusPageIncidents")
    ]
...
class MonitorDto(BaseModel):
    ...
    name: Annotated[str, Field(description="Human-readable name for this monitor")]
    type: Type3
    config: (
        DnsMonitorConfig
    ...
    assertions: Annotated[
        list[MonitorAssertionDto],
        Field(
            description="Assertions evaluated against each check result; null on list responses"
        ),
    ]
    tags: Annotated[list[TagDto], Field(description="Tags applied to this monitor")]
    ping_url: Annotated[
        str,
        Field(
            alias="pingUrl",
    ...
    incident_policy: Annotated[IncidentPolicyDto, Field(alias="incidentPolicy")]
...
class ResourceGroupDto(BaseModel):
    ...
    slug: Annotated[str, Field(description="URL-safe group identifier")]
    description: Annotated[str, Field(description="Optional group description")]
    alert_policy_id: Annotated[
        UUID,
        Field(
            alias="alertPolicyId",
    ...
    default_retry_strategy: Annotated[
        RetryStrategy, Field(alias="defaultRetryStrategy")
    ]
    default_alert_channels: Annotated[
        list[UUID],
        Field(
    ...
    health_threshold_value: Annotated[
        float, Field(alias="healthThresholdValue", description="Health threshold value")
    ]
    suppress_member_alerts: Annotated[
        bool,
        Field(
...
class ServiceDetailDto(BaseModel):
    ...
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
    updated_at: Annotated[AwareDatetime, Field(alias="updatedAt")]
    current_status: Annotated[ServiceStatusDto, Field(alias="currentStatus")]
    ...
    data_completeness: Annotated[str, Field(alias="dataCompleteness")]
    seo_metadata: Annotated[SeoMetadataDto, Field(alias="seoMetadata")]
    related_services: Annotated[list[ServiceCatalogDto], Field(alias="relatedServices")]
...
class ServiceIncidentDetailDto(BaseModel):
    ...
    detected_at: Annotated[AwareDatetime, Field(alias="detectedAt")]
    shortlink: str
    affected_components: Annotated[list[str], Field(alias="affectedComponents")]
...
class SingleValueResponseMapStringListComponentUptimeDayDto(BaseModel):
    data: dict[str, list[ComponentUptimeDayDto]]
...
class StatusPageIncidentDto(BaseModel):
    ...
    impact: Impact
    scheduled: bool
    scheduled_for: Annotated[AwareDatetime, Field(alias="scheduledFor")]
    scheduled_until: Annotated[AwareDatetime, Field(alias="scheduledUntil")]
    ...
    resolved_at: Annotated[AwareDatetime, Field(alias="resolvedAt")]
    created_by_user_id: Annotated[int, Field(alias="createdByUserId")]
    postmortem_body: Annotated[str, Field(alias="postmortemBody")]
    postmortem_url: Annotated[str, Field(alias="postmortemUrl")]
    affected_components: Annotated[
        list[StatusPageIncidentComponentDto], Field(alias="affectedComponents")
    ]
    updates: list[StatusPageIncidentUpdateDto]
    created_at: Annotated[AwareDatetime, Field(alias="createdAt")]
    updated_at: Annotated[AwareDatetime, Field(alias="updatedAt")]
...
class UpdateMonitorRequest(BaseModel):
    ...
    enabled: Annotated[
        bool, Field(description="Enable or disable the monitor; null preserves current")
    ]
    regions: Annotated[
        list[str], Field(description="New probe regions; null preserves current")
    ]
    managed_by: Annotated[
        ManagedBy,
        Field(
    ...
    incident_policy: Annotated[
        UpdateIncidentPolicyRequest, Field(alias="incidentPolicy")
    ]
    alert_channel_ids: Annotated[
        list[UUID],
        Field(
...
class CreateMonitorRequest(BaseModel):
    ...
    type: Annotated[Type1, Field(description="Monitor protocol type")]
    config: (
        DnsMonitorConfig
        | HeartbeatMonitorConfig
        | HttpMonitorConfig
