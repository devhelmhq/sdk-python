...
class Webhooks:
    ...
    def list(self) -> list[Any]:
        ...
        return fetch_all_pages(self._client, "/api/v1/webhooks")

    def list_page(self, page: int, size: int) -> Page[Any]:
        """List webhook endpoints with manual page control."""
        return fetch_page(self._client, "/api/v1/webhooks", page, size)
    ...
    def create(self, body: dict[str, Any]) -> Any:
        ...
        return unwrap_single(api_post(self._client, "/api/v1/webhooks", body))
